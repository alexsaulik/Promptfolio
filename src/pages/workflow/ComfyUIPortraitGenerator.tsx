...
const ComfyUIPortraitGenerator = () => {
    const workflow = {
        id: "1",
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                                        ...
                                        <li>Open ComfyUI and drag the file into the interface</li>
                                        <li>Install required models from the model list</li>
                                        <li>Configure your input image node</li>
                                        <li>Run the workflow and enjoy!</li>
                                    </ol>
                                </CardContent>
                            </Card>
                        </div>
...
export default ComfyUIPortraitGenerator;
