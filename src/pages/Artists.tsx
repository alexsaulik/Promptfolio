...
import { Download, ExternalLink, Filter, Music, Play, Plus, Search, Users, Verified } from "lucide-react";
...
const Artists = () => {
    ...
    const filteredArtists = artists.filter(artist => {
        ...
        const matchesGenre = selectedGenre === 'all' ||
            artist.genre.some(g => g.toLowerCase() === selectedGenre.toLowerCase());
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center mb-12 relative">
                            <div className="flex items-center justify-center gap-3 mb-4">
                                ...
                                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-glow-pulse hover:scale-105 transition-transform duration-300 cursor-pointer">
                                    Featured Artists
                                </h1>
                                {isAdmin && (
                                    <Button
                            ...
                            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-8">
                                <div className="text-center space-y-2">
                                    <div className="flex items-center justify-center text-2xl md:text-3xl font-bold text-primary">
                                        ...
                                        <NumberTicker value={artists.length || 150} />+
                                    </div>
                                    <p className="text-sm text-muted-foreground">Professional Artists</p>
                                </div>
                                <div className="text-center space-y-2">
                                    <div className="flex items-center justify-center text-2xl md:text-3xl font-bold text-primary">
                                    ...
                                    <p className="text-sm text-muted-foreground">High Quality Tracks</p>
                                </div>
                                <div className="text-center space-y-2">
                                    <div className="flex items-center justify-center text-2xl md:text-3xl font-bold text-primary">
                        ...
                        {featuredArtist && (
                            <div className="mb-16">
                                ...
                                <div className="flex justify-center relative">
                                    <Spotlight
                                        className="absolute -top-20 left-0 md:left-60 md:-top-20"
                                        fill="white"
                                    />
                                    <CometCard className="max-w-4xl">
                            ...
                            {filteredArtists.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                    {filteredArtists.map((artist, index) => (
                                        <Card key={artist.id} className="group overflow-hidden hover:shadow-elevated transition-all duration-300 hover:scale-105 hover:border-primary/50 animate-fade-in bg-card/50 backdrop-blur-sm border-border/50" style={{ animationDelay: `${index * 100}ms` }}>
                                            <div className="relative">
                                                <img
